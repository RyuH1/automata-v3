...
pub mod pallet {
    ...
    impl<T: Config> OnAutomataOffenceHandler<T::AccountId, T::BlockNumber, Weight> for Pallet<T> {
        fn on_offence(
    ...
    impl<T: Config, O: AutomataOffence<T::AccountId>>
        AutomataReportOffence<T::AccountId, T::AccountId, O> for Pallet<T>
    {
